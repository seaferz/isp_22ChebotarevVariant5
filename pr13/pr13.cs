...
using (var reader1 = new StreamReader(a))
using (var writer2 = new StreamWriter(otr))
using (var writer3 = new StreamWriter(plus))
using (var writer4 = new StreamWriter(even))
{
    string line1;
